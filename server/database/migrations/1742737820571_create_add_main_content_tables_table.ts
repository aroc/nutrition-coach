...
export default class extends BaseSchema {
  async up() {
    this.schema.createTable('logged_food_items', (table) => {
      ...
      table.integer('fat_grams_saturated').nullable()
      table.integer('fat_monounsaturated').nullable()
      table.integer('fat_polyunsaturated').nullable()
      table.integer('carbs').nullable()
      table.integer('carbs_fiber').nullable()
      table.integer('carbs_sugar').nullable()
